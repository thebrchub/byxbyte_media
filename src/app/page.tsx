...
/* ------------------ Services ------------------ */
const services = [
  { img: "/works/works02.png", title: "Video Production", desc: "High-impact video content that blends cinematic storytelling with brand identity." },
  { img: "/works/grade01.png", title: "Color Grading", desc: "Professional grading to craft mood, style, and visual depth for your films." },
  { img: "/works/post01.png", title: "Post-production", desc: "Full post-production services: editing, sound design, and delivery." },
];
  ...
  return (
    ...
    >
      ...
      <p className="text-xl text-gray-300 leading-relaxed max-w-4xl mx-auto mb-6">
        ...
        blending video production, design, and VFX to help brands and creators craft stories that resonate.
      </p>
      <p className="text-lg text-gray-400 leading-relaxed max-w-3xl mx-auto">
        From cinematic ad films to cutting-edge motion design, we create content that not only looks good but drives engagement and growth.
      </p>
    </motion.section>
  );
}
  ...
  return (
    ...
    >
      ...
      <p className="text-xl text-gray-300 mb-12 max-w-2xl mx-auto">
        Whether it’s a brand film, a digital campaign, or full-stack development, we’ll bring your vision to life.
      </p>
      <div className="flex flex-col sm:flex-row gap-4 justify-center">
        <Link href="/Contact" className="inline-flex items-center gap-2 px-10 py-5 bg-white text-black font-bold rounded-2xl shadow-xl hover:-translate-y-1 transition group">
          Start Your Project
          <ArrowRight className="w-6 h-6 group-hover:translate-x-1 transition-transform" />
        </Link>
        <Link href="/Work" className="inline-flex items-center gap-2 px-10 py-5 bg-gradient-to-r from-gray-800 to-gray-700 text-white font-bold rounded-2xl border border-gray-600/40 shadow-lg hover:-translate-y-1 transition group">
